...
exports.validateRequest = (schema) => (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    try {
...
exports.authenticateUser = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
    var _a;
    try {
